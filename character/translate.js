...
const translates = {
	...
	poqun_rixun: "日询",
	poqun_rixun_info:
		"出牌阶段限一次，你将一张手牌交给一名其他角色，若如此做，该角色回合开始时须选择一项: 1. 跳过摸牌阶段，令其此回合出牌阶段伤害+1。2.跳过出牌阶段，令你与其各摸1张牌。",
	poqn_touxian: "偷闲",
	...
	poqun_leshi_tag: "乐施",
	poqun_leshi_info:
		"其他角色出牌阶段开始时，你可以令其观看你的手牌并获得一张。其出牌阶段结束时，其展示全部手牌，若此牌不在其手牌，其手牌上限-1；且若其于此阶段回复过体力或造成过伤害，你可分别摸一张牌",
	poqun_ziyu: "资愈",
