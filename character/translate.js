...
const translates = {
	...
	poqun_juyi: "聚义",
	poqun_juyi_info:
		"出牌阶段限一次，你可以声明一张此阶段未声明过的单目标锦囊牌牌名，其他角色须依次决定是否响应。若响应的人数不小于未响应角色数，你立即使用你声明的牌。",
	poqun_shengwei: "声威",
	poqun_shengwei_info:
		'主公技，准备阶段，你的【聚义】描述可选择一项修改：1.将"响应的人数不小于"改为"响应的人数+蜀势力角色数大于"；2.将"出牌阶段限一次"改为"出牌阶段限两次"；3.将"单目标锦囊牌"改为"单目标锦囊牌或基本牌"。',

	poqun_gule: "古乐",
	poqun_guangyin: "光引",
	poqun_guangyin_info:
		"当一名角色的判定牌生效前，你可以令其观看牌堆底两张牌，选择一张作为判定牌。锁定技，你弃置的牌不进入弃牌堆，改为以任意顺序置于牌堆底。",
	poqun_jidou: "激斗",
	poqun_jidou_info:
	...
	poqun_yiyu: "疑谕",
	poqun_yiyu_info:
		"出牌阶段限一次，你可以观看牌堆顶一张牌，然后声明其花色和点数。其他角色依次选择是否质疑，然后你展示该牌。若无人质疑，未质疑角色获得“罔”；反之，若你声明正确，质疑的角色获得“罔”；若你的声明错误，质疑的角色摸一张牌。若有角色因此法获得“罔”，你摸1张牌。",
	poqun_wangfu: "妄缚",
	poqun_wangfu_info:
